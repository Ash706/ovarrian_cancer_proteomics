...
## 
###' Apply loess and vsn normalization to a SummarizedExperiment(Se) and return and object of the Se class
###' @param x an object of the the class SummarizedExperimeny
###' @param assay name of the assay to be normalized (e.g., raw data)
###' @param method 